...
import {
  ...
  ResultaatDestroyParams,
  ResultaatHeadersData,
  ResultaatHeadersParams,
  ResultaatListData,
  ResultaatListParams,
  ResultaatPartialUpdateData,
  ResultaatPartialUpdateParams,
  ResultaatRetrieveData,
  ResultaatRetrieveParams,
  ResultaatUpdateData,
  ResultaatUpdateParams,
  ValidatieFout,
} from "./data-contracts";
...
export class Resultaten<SecurityDataType = unknown> {
   ...
   */
  resultaatRetrieve = (
    { uuid, ...query }: ResultaatRetrieveParams,
   ...
   */
  resultaatUpdate = (
    { uuid }: ResultaatUpdateParams,
    data: Partial<Resultaat>,
    params: RequestParams = {},
  ) =>
  ...
  resultaatPartialUpdate = (
    { uuid }: ResultaatPartialUpdateParams,
    data: Partial<PatchedResultaat>,
    params: RequestParams = {},
  ) =>
