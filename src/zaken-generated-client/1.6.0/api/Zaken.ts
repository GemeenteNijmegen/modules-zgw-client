...
import {
  ...
  ZaakbesluitCreateParams,
  ZaakbesluitDestroyData,
  ZaakbesluitDestroyParams,
  ZaakbesluitListData,
  ZaakbesluitListParams,
  ZaakbesluitRetrieveData,
  ZaakbesluitRetrieveParams,
  ZaakeigenschapCreateData,
  ZaakeigenschapCreateParams,
  ZaakeigenschapDestroyData,
  ZaakeigenschapDestroyParams,
  ZaakeigenschapHeadersData,
  ZaakeigenschapHeadersParams,
  ZaakeigenschapListData,
  ZaakeigenschapListParams,
  ZaakeigenschapPartialUpdateData,
  ZaakeigenschapPartialUpdateParams,
  ZaakeigenschapRetrieveData,
  ZaakeigenschapRetrieveParams,
  ZaakeigenschapUpdateData,
  ZaakeigenschapUpdateParams,
} from "./data-contracts";
...
export class Zaken<SecurityDataType = unknown> {
   ...
   */
  zaakPartialUpdate = (
    { uuid }: ZaakPartialUpdateParams,
    data: Partial<PatchedZaak>,
    params: RequestParams = {},
  ) =>
   ...
   * @secure
   */
  zaakDestroy = ({ uuid }: ZaakDestroyParams, params: RequestParams = {}) =>
   ...
   */
  zaakHeaders = ({ uuid }: ZaakHeadersParams, params: RequestParams = {}) =>
   ...
   */
  audittrailRetrieve = (
    { uuid, zaakUuid }: AudittrailRetrieveParams,
    params: RequestParams = {},
  ) =>
   ...
   */
  zaakbesluitList = (
    { zaakUuid, ...query }: ZaakbesluitListParams,
    params: RequestParams = {},
  ) =>
   ...
   */
  zaakbesluitCreate = (
    { zaakUuid }: ZaakbesluitCreateParams,
    data: Partial<ZaakBesluit>,
    params: RequestParams = {},
  ) =>
   ...
   */
  zaakbesluitRetrieve = (
    { uuid, zaakUuid, ...query }: ZaakbesluitRetrieveParams,
    params: RequestParams = {},
  ) =>
   ...
   */
  zaakbesluitDestroy = (
    { uuid, zaakUuid }: ZaakbesluitDestroyParams,
    params: RequestParams = {},
  ) =>
   ...
   */
  zaakeigenschapList = (
    { zaakUuid }: ZaakeigenschapListParams,
    params: RequestParams = {},
  ) =>
  ...
  zaakeigenschapCreate = (
    { zaakUuid }: ZaakeigenschapCreateParams,
    data: Partial<ZaakEigenschap>,
    params: RequestParams = {},
  ) =>
   ...
   * @secure
   */
  zaakeigenschapRetrieve = (
    { uuid, zaakUuid }: ZaakeigenschapRetrieveParams,
    params: RequestParams = {},
  ) =>
  ...
  zaakeigenschapUpdate = (
    { uuid, zaakUuid }: ZaakeigenschapUpdateParams,
    data: Partial<ZaakEigenschap>,
    params: RequestParams = {},
  ) =>
  ...
  zaakeigenschapPartialUpdate = (
    { uuid, zaakUuid }: ZaakeigenschapPartialUpdateParams,
   ...
   * @secure
   */
  zaakeigenschapDestroy = (
    { uuid, zaakUuid }: ZaakeigenschapDestroyParams,
    params: RequestParams = {},
  ) =>
   ...
   */
  zaakeigenschapHeaders = (
    { uuid, zaakUuid }: ZaakeigenschapHeadersParams,
    params: RequestParams = {},
  ) =>
   ...
   */
  zaakZoek = (
    query: ZaakZoekParams,
    data: Partial<ZaakZoek>,
    params: RequestParams = {},
  ) =>
