...
import {
  ...
  ZaakverzoekDestroyParams,
  ZaakverzoekListData,
  ZaakverzoekListParams,
  ZaakverzoekRetrieveData,
  ZaakverzoekRetrieveParams,
} from "./data-contracts";
...
export class Zaakverzoeken<SecurityDataType = unknown> {
   ...
   */
  zaakverzoekRetrieve = (
    { uuid }: ZaakverzoekRetrieveParams,
    params: RequestParams = {},
  ) =>
