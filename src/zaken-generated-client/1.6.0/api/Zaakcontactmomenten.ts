...
export class Zaakcontactmomenten<SecurityDataType = unknown> {
  ...
  zaakcontactmomentList = (
    query: ZaakcontactmomentListParams,
  ...
  zaakcontactmomentCreate = (
    data: Partial<ZaakContactMoment>,
    params: RequestParams = {},
  ) =>
   ...
   * @secure
   */
  zaakcontactmomentRetrieve = (
    { uuid }: ZaakcontactmomentRetrieveParams,
    params: RequestParams = {},
  ) =>
   ...
   * @secure
   */
  zaakcontactmomentDestroy = (
    { uuid }: ZaakcontactmomentDestroyParams,
    params: RequestParams = {},
  ) =>
