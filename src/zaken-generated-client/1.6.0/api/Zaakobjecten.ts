...
import {
  ...
  ZaakobjectDestroyParams,
  ZaakobjectHeadersData,
  ZaakobjectHeadersParams,
  ZaakobjectListData,
  ZaakobjectListParams,
  ZaakobjectPartialUpdateData,
  ZaakobjectPartialUpdateParams,
  ZaakobjectRetrieveData,
  ZaakobjectRetrieveParams,
  ZaakobjectUpdateData,
  ZaakobjectUpdateParams,
} from "./data-contracts";
...
export class Zaakobjecten<SecurityDataType = unknown> {
   ...
   */
  zaakobjectRetrieve = (
    { uuid, ...query }: ZaakobjectRetrieveParams,
   ...
   */
  zaakobjectUpdate = (
    { uuid }: ZaakobjectUpdateParams,
    data: Partial<ZaakObject>,
    params: RequestParams = {},
  ) =>
  ...
  zaakobjectPartialUpdate = (
    { uuid }: ZaakobjectPartialUpdateParams,
    data: Partial<PatchedZaakObject>,
    params: RequestParams = {},
  ) =>
