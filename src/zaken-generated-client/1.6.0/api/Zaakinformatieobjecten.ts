...
export class Zaakinformatieobjecten<SecurityDataType = unknown> {
  ...
  zaakinformatieobjectList = (
    query: ZaakinformatieobjectListParams,
  ...
  zaakinformatieobjectCreate = (
    data: Partial<ZaakInformatieObject>,
    params: RequestParams = {},
  ) =>
   ...
   * @secure
   */
  zaakinformatieobjectRetrieve = (
    { uuid, ...query }: ZaakinformatieobjectRetrieveParams,
    params: RequestParams = {},
  ) =>
  ...
  zaakinformatieobjectUpdate = (
    { uuid }: ZaakinformatieobjectUpdateParams,
    data: Partial<ZaakInformatieObject>,
    params: RequestParams = {},
  ) =>
  ...
  zaakinformatieobjectPartialUpdate = (
    { uuid }: ZaakinformatieobjectPartialUpdateParams,
   ...
   * @secure
   */
  zaakinformatieobjectDestroy = (
    { uuid }: ZaakinformatieobjectDestroyParams,
    params: RequestParams = {},
  ) =>
   ...
   */
  zaakinformatieobjectHeaders = (
    { uuid }: ZaakinformatieobjectHeadersParams,
    params: RequestParams = {},
  ) =>
