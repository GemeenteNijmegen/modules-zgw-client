...
export class Rollen<SecurityDataType = unknown> {
   ...
   * @secure
   */
  rolRetrieve = ({ uuid }: RolRetrieveParams, params: RequestParams = {}) =>
   ...
   * @secure
   */
  rolDestroy = ({ uuid }: RolDestroyParams, params: RequestParams = {}) =>
   ...
   */
  rolHeaders = ({ uuid }: RolHeadersParams, params: RequestParams = {}) =>
