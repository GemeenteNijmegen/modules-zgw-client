...
export class Enkelvoudiginformatieobjecten<SecurityDataType = unknown> {
  ...
  /**
   * @description Dit creëert altijd een nieuwe versie van het (ENKELVOUDIG) INFORMATIEOBJECT. **Er wordt gevalideerd op** - correcte `lock` waarde - het `informatieobjecttype` mag niet gewijzigd worden - status NIET `definitief`
   *
   * @tags enkelvoudiginformatieobjecten
