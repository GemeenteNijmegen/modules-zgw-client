...
export interface components {
  schemas: {
    ...
    EnkelvoudigInformatieObject: {
      ...
      /**
             * inhoud is vervallen
             * @description Geeft aan of de inhoud van het INFORMATIEOBJECT al dan niet  vervallen, dus niet langer geldig is.
      ...
      /**
             * @description Een lijst van één of meer trefwoorden.
             * @example [
             *       "bouwtekening",
             *       "vergunning",
             *       "aanvraag"
    ...
    EnkelvoudigInformatieObjectExpanded: components['schemas']['EnkelvoudigInformatieObject'] & {
      _expand?: components['schemas']['EnkelvoudigInformatieObjectEmbedded'];
    };
    ...
    GebruiksrechtenExpanded: components['schemas']['Gebruiksrechten'] & {
      _expand?: components['schemas']['GebruiksrechtenEmbedded'];
    };
    GebruiksrechtenEmbedded: {
    ...
    PaginatedEnkelvoudigInformatieObjectList: {
      ...
      results?: components['schemas']['EnkelvoudigInformatieObjectExpanded'][];
    };
    PaginatedVerzendingList: {
      ...
      /**
             ...
             */
      previous?: string | null;
      results?: components['schemas']['VerzendingExpanded'][];
    };
    /** @description This serializer class is used by EnkelvoudigInformatieObjectViewSet for
         *     update and partial_update operations */
    ...
    VerzendingExpanded: components['schemas']['Verzending'] & {
      _expand?: components['schemas']['VerzendingEmbedded'];
    };
    VerzendingEmbedded: {
      informatieobject?: components['schemas']['EnkelvoudigInformatieObject'];
    };
  ...
  enkelvoudiginformatieobject_retrieve: {
    ...
    responses: {
      ...
      200: {
        ...
        content: {
          'application/json': components['schemas']['EnkelvoudigInformatieObjectExpanded'];
        };
      };
      /** @description Unauthorized */
      401: {
  ...
  gebruiksrechten_list: {
    ...
    responses: {
      ...
      200: {
        ...
        content: {
          'application/json': components['schemas']['GebruiksrechtenExpanded'][];
        };
      };
      /** @description Bad request */
      400: {
  ...
  verzending_retrieve: {
    ...
    responses: {
      ...
      200: {
        ...
        content: {
          'application/json': components['schemas']['VerzendingExpanded'];
        };
      };
      /** @description Unauthorized */
      401: {
