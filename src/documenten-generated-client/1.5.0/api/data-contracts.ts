...
export interface EnkelvoudigInformatieObject {
   ...
   */
  inhoudIsVervallen?: boolean | null;
  /**
   * formaat
  ...
  /**
   * Een lijst van één of meer trefwoorden.
   * @example ["bouwtekening","vergunning","aanvraag"]
   */
  trefwoorden?: string[];
}
...
export type EnkelvoudigInformatieObjectExpanded = EnkelvoudigInformatieObject & {
  _expand?: EnkelvoudigInformatieObjectEmbedded;
};

export interface EnkelvoudigInformatieObjectEmbedded {
...
export type GebruiksrechtenExpanded = Gebruiksrechten & {
  _expand?: GebruiksrechtenEmbedded;
};

export interface GebruiksrechtenEmbedded {
  /** Serializer for the EnkelvoudigInformatieObject model */
...
export interface PaginatedEnkelvoudigInformatieObjectList {
  ...
  results?: EnkelvoudigInformatieObjectExpanded[];
}
...
export type VerzendingExpanded = Verzending & {
  _expand?: VerzendingEmbedded;
};

export interface VerzendingEmbedded {
  /** Serializer for the EnkelvoudigInformatieObject model */
  informatieobject?: EnkelvoudigInformatieObject;
}
...
export type EnkelvoudiginformatieobjectRetrieveData = EnkelvoudigInformatieObjectExpanded;
...
export type EnkelvoudiginformatieobjectHeadersData = any;
...
export type GebruiksrechtenListData = GebruiksrechtenExpanded[];

export type GebruiksrechtenCreateData = Gebruiksrechten;

export interface GebruiksrechtenRetrieveParams {
  /**
   * Haal details van gelinkte resources direct op. Als je meerdere resources tegelijk wilt ophalen kun je deze scheiden met een komma. Voor het ophalen van resources die een laag dieper genest zijn wordt de punt-notatie gebruikt.
   * @example "informatieobject"
   */
...
export type GebruiksrechtenRetrieveData = GebruiksrechtenExpanded;
...
export type GebruiksrechtenHeadersData = any;
...
export type ObjectinformatieobjectHeadersData = any;
...
export interface VerzendingRetrieveParams {
  /**
   * Haal details van gelinkte resources direct op. Als je meerdere resources tegelijk wilt ophalen kun je deze scheiden met een komma. Voor het ophalen van resources die een laag dieper genest zijn wordt de punt-notatie gebruikt.
   * @example "informatieobject"
   */
...
export type VerzendingRetrieveData = VerzendingExpanded;
...
export type VerzendingHeadersData = any;
