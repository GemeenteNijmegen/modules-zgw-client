...
export interface BesluitTypeCreate {
  /**
   * url
   * URL-referentie naar dit object. Dit is de unieke identificatie en locatie van dit object.
   * @format uri
  ...
  /**
   * informatieobjecttypen
   * `Omschrijvingen` van het INFORMATIEOBJECTTYPE van informatieobjecten waarin besluiten van dit BESLUITTYPE worden vastgelegd.
   */
  informatieobjecttypen: string[];
  /**
   * datum begin geldigheid
...
export interface BesluitTypeUpdate {
  /**
   * url
   * URL-referentie naar dit object. Dit is de unieke identificatie en locatie van dit object.
   * @format uri
 ...
 * Usage: include the mixin on the ModelSerializer that has gegevensgroepen.
 */
export interface ResultaatTypeCreate {
  /**
   * url
   * URL-referentie naar dit object. Dit is de unieke identificatie en locatie van dit object.
   * @format uri
 ...
 * Usage: include the mixin on the ModelSerializer that has gegevensgroepen.
 */
export interface ResultaatTypeUpdate {
  /**
   * url
   * URL-referentie naar dit object. Dit is de unieke identificatie en locatie van dit object.
   * @format uri
 ...
 * Usage: include the mixin on the ModelSerializer that has gegevensgroepen.
 */
export interface ZaakTypeCreate {
  /**
   * url
   * URL-referentie naar dit object. Dit is de unieke identificatie en locatie van dit object.
   * @format uri
  ...
  /**
   * zaaktypen
   * `Omschrijvingen` van BESLUITTYPEN die mogelijk zijn binnen dit ZAAKTYPE.
   */
  besluittypen: string[];
  /**
   * deelzaaktypen
   * De `zaaktypen.identificaties` waaronder ZAAKen als deelzaak kunnen voorkomen bij ZAAKen van dit ZAAKTYPE.
   */
   ...
   * De ZAAKTYPEn van zaken die relevant zijn voor zaken van dit ZAAKTYPE.
   */
  gerelateerdeZaaktypen: ZaakTypenRelatieCreate[];
  /**
   * datum begin geldigheid
   * De datum waarop het is ontstaan.
   * @format date
 ...
 * Usage: include the mixin on the ModelSerializer that has gegevensgroepen.
 */
export interface ZaakTypeUpdate {
  /**
   * url
   * URL-referentie naar dit object. Dit is de unieke identificatie en locatie van dit object.
   * @format uri
...
export interface ZaakTypenRelatieCreate {
  /**
   * zaaktype van
   * `zaaktype.identificatie` naar het ZAAKTYPE.
   */
  zaaktype: string;
  /**
   * aard relatie
...
export type BesluittypePartialUpdateData = Record<string, any>;

/** Unspecified response body */
export type BesluittypeDestroyData = Record<string, any>;
...
/** Unspecified response body */
export type InformatieobjecttypeUpdateData = Record<string, any>;

/** Unspecified response body */
export type InformatieobjecttypePartialUpdateData = Record<string, any>;

/** Unspecified response body */
export type InformatieobjecttypeDestroyData = Record<string, any>;
...
export type ResultaattypeUpdateData = ResultaatTypeUpdate;
...
export interface ZaaktypeRetrieveParams {
  /** filter op datumGeldigheid voor het zelf en alle onderliggende objecten */
  datumGeldigheid?: string;
  /**
   * uuid
...
/** Unspecified response body */
export type ZaaktypePartialUpdateData = Record<string, any>;

/** Unspecified response body */
export type ZaaktypeDestroyData = Record<string, any>;
