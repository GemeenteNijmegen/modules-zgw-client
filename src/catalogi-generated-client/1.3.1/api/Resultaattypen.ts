...
export class Resultaattypen<SecurityDataType = unknown> {
   ...
   * @secure
   */
  resultaattypeCreate = (data: Partial<ResultaatTypeCreate>, params: RequestParams = {}) =>
   ...
   * @secure
   */
  resultaattypeUpdate = (uuid: string, data: Partial<ResultaatTypeCreate>, params: RequestParams = {}) =>
